...
# 34 "./program.h"
    ...
    void lcd_PrintDigitInt32(int32_t number, uint8_t noDigit, _Bool enSign, _Bool enZero);
...
void programLoop(void) {
    ...
    lcd_Goto(1, 0);
    lcd_PrintDigitInt32((uint16_t)motorSpeed, 5, 0, 1);
    ...
    while(1) {
        if(!PORTAbits.RA1) {
            ...
            if(motorSpeed < 65535) motorSpeed +=1000;


            if(motorSpeed > 65535) motorSpeed = 65000;
...
void lcd_WriteData(uint8_t data) {
    ...
    LATCbits.LATC5 = (data >> 7) & 0x01;
    LATBbits.LATB1 = (data >> 6) & 0x01;
    LATBbits.LATB2 = (data >> 5) & 0x01;
    LATBbits.LATB3 = (data >> 4) & 0x01;

    lcd_EPulse();


    LATCbits.LATC5 = (data >> 3) & 0x01;
    LATBbits.LATB1 = (data >> 2) & 0x01;
    LATBbits.LATB2 = (data >> 1) & 0x01;
    LATBbits.LATB3 = data & 0x01;
...
void motor_Initialize(void) {
    ...
    PSMC1CONbits.P1MODE = 1;


    PSMC1CLKbits.P1CPRE = 0;
    PSMC1CLKbits.P1CSRC = 0;

    PSMC1OENbits.P1OEB = 1;
    PSMC1POLbits.P1POLB = 1;

    PSMC1PHSbits.P1PHST = 1;
    PSMC1DCSbits.P1DCST = 1;
    PSMC1PRSbits.P1PRST = 1;

    PSMC1STR0bits.P1STRB = 1;
